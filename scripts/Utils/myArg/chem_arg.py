...
def add_arguments(parser):
    ...
    parser.add_argument('--Super', action='store_true', default=False, help='interrupt at Superclass')
    parser.add_argument('--Class', action='store_true', default=False, help=' interrupt at Class')
    parser.add_argument('--Sub', action='store_true', default=False, help='interrupt at Subclass')
